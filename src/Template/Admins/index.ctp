  ...
  <section class="content">
       <div class="box-body">
        <div class="row">
          ...
          <div class="col-lg-2 col-md-2 col-sm-2 col-xs-4">
              <a href="#" id="btnAddScene" class="btn btn-block btn-primary">
               Add Scene
              </a>
          </div>
        </div>
                ...
                <div class="info-box da-thumbs">
                  ...
                  <article class="da-animate da-slideFromLeft" style="display: block;">
                      ...
                      <h3 class="fonts-title"><?php echo $scene->title; ?></h3>
                        <span><a class="vieScene" href="/admins/editscene"><i class="fa fa-eye"></i></a></span>
                        <span>
                          <a class="editScene" href="#" sceneId="<?php echo $scene->id; ?>" sceneName="<?php echo $scene->name ?>">
